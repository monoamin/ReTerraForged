package raccoonman.reterraforged.world.worldgen.rivergen.render;
...
public class RenderHandler {
    ...
    //@SubscribeEvent
    public static void onRenderLevelStageEvent(Object event) {
        PoseStack pose = new PoseStack(); //event.getPoseStack();
