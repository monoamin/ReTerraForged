package raccoonman.reterraforged.world.worldgen.rivergen.terrain.carver;
...
public class TerrainCarver {
    ...
    private void carveSegment(SplineNode startNode, SplineNode endNode, float cumulativeLength, float totalLength) {
        ...
        for (int step = 0; step <= numSteps; step++) {
            ...
            int yLevelDiff = 0;//TerrainUtils.getYValueAt(interpolatedPoint)-(int)interpolatedPoint.y + 2;
